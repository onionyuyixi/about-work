package com.example.aboutwork.hanzi2pinyin;
...
public class ChineseCharToEnUtil {
    ...
    public static void main(String[] args) {
        HanyuPinyinOutputFormat formatter = getFormatter(HanyuPinyinCaseType.LOWERCASE,
                HanyuPinyinToneType.WITHOUT_TONE, HanyuPinyinVCharType.WITH_U_AND_COLON);
        System.out.println(onePinyin("崇龙"));
    }
    /**
     * 获取传入中文的拼音首字母
     * @param chinese 汉字
     */
    public static String onePinyin(String chinese){
        String pinYin = cn2Pinyin(chinese);
